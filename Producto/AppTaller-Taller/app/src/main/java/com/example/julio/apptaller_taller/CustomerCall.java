...
public class CustomerCall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFCMService = Tablas.getFCMService();
    ...
    private void cancelBooking(String customerId) {
        ...
        /*Notification notification = new Notification("Cancelado","El mecanico cancelo su peticion");
        Sender sender = new Sender(token.getToken(),notification);*/

        Map<String,String> content = new HashMap<>();
        content.put("title","Cancelar");
        content.put("message","El mecanico ha cancelado la solicitud");
        ...
        mFCMService.sendMessage(dataMessage)
                .enqueue(new Callback<FCMResponse>() {
                    ...
                    public void onResponse(Call<FCMResponse> call, Response<FCMResponse> response) {
                        ...
                        {
                            Toast.makeText(CustomerCall.this,"Cancelado",Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
    ...
    private void getDirection(double lat, double lng) {
        ...
        try{
            requestApi = "https://maps.googleapis.com/maps/api/directions/json?"+
                    ...
                    "origin="+ Tablas.mLastLocation.getLatitude()+","+ Tablas.mLastLocation.getLongitude()+"&"+
                    "destination="+lat+","+lng+"&"+
