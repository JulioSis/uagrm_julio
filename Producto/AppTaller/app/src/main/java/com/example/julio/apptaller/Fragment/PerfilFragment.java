...
public class PerfilFragment extends Fragment {
    ...
    private void showDialogUpdateInfo() {
        ...
        edtName.setText(Tablas.currentUser.getName());
        ...
        alertDialog.setPositiveButton("Actualizar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                DatabaseReference userInformation = FirebaseDatabase.getInstance().getReference(Tablas.user_conductores_tbl);
